(function () {
  ...
  var baseUrl = 'http://localhost:5000'; // Default API URL, change to your backend subdomain (e.g. https://api.yourdomain.com)
  ...
  function openReferralModal() {
    ...
    form.onsubmit = async function (e) {
      ...
      try {
        ...
        // Fixed: was incorrectly checking data.devCredentials — backend returns data.credentials
        if (data.credentials) {
