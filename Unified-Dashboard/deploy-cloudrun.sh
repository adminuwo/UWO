#!/usr/bin/env bash
# ==============================================================================
# Unified Dashboard Frontend - GCP Cloud Run Deployment Script (Bash)
# ==============================================================================

set -eo pipefail

SERVICE_NAME="${1:-unified-dashboard}"
REGION="${2:-asia-south1}"
BACKEND_API_URL="${3:-https://uwo24.com}"
MEMORY="512Mi"
CPU="1"
MIN_INSTANCES="0"
MAX_INSTANCES="10"
...
echo "=========================================================="
echo "🚀 Deploying Unified Dashboard Frontend to Google Cloud Run"
echo "=========================================================="
...
echo "Unified Dashboard is live on Cloud Run and mapped to admin.uwo24.com"
echo "=========================================================="
