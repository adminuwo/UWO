...
export const UnifiedAnalytics = () => {
  ...
  const copySnippet = (appName, siteId) => {
    const baseUrl = API_BASE_URL || (window.location.hostname === 'localhost' ? window.location.origin : 'https://uwo24.com');
              ...
              {[
                ...
                <div key={item.site} style={{ background: '#0f172a', padding: '12px', borderRadius: '8px', border: '1px solid #334155' }}>
                  ...
                  <pre style={{ margin: 0, fontSize: '11px', color: '#94a3b8', overflowX: 'auto', background: 'transparent' }}>
                    {`<script defer src="${API_BASE_URL || (window.location.hostname === 'localhost' ? window.location.origin : 'https://uwo24.com')}/api/web-stats/tracker.js" data-site="${item.site}" data-endpoint="${API_BASE_URL || (window.location.hostname === 'localhost' ? window.location.origin : 'https://uwo24.com')}/api/web-stats/collect"></script>`}
                  </pre>
                </div>
              ))}
            </div>
